from taskmaster.api.resources.transcription.service.service import AbstractTranscriptionService
from taskmaster.api.resources.transcription.types.transcription_response import TranscriptionResponse
